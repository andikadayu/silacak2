...
public class dataTampilPesanModelUser {
    public int messageType;
    public String MId_pesan, MId_pengirim, MId_penerima, MPesan, MTanggal, MJam;

    public dataTampilPesanModelUser(String MId_pesan, String MId_pengirim, String MId_penerima, String MPesan, String MTanggal, String MJam, int messageType) {
